...
export const flashcards: Flashcard[] = [
  ...
  {"id": 389,"front": "LEK source drill — What drug detail, dose, route, or interval is listed for calcium gluconate?","back": "GIVE 10% calcium gluconate 1 mL/kg IV over ~10 minutes for symptomatic hypocalcaemic tetany, with cardiac-rhythm monitoring throughout. [CORRECTED: the source says “Do not give” here, but its own treatment section says “Administer 10% calcium gluconate solution at a dose of 1 mL/kg” and its treatment table lists “Symptomatic tetany | Calcium gluconate | 1 mL/kg IV”. The negation is a translation artefact.] Legacy source number — verify against current local/national guidance before clinical use.","status": "source-derived","category": "pharma","sourceAtomId": "LEK-01541"},
  ...
  {"id": 409,"front": "LEK source drill — What exception, contraindication, or “false statement” trap is listed under Other / mixed?","back": "GIVE 10% glucose 2 mL/kg (200 mg/kg) as the bolus for neonatal hypoglycaemia, then continue an infusion at 8–15 mg/kg/min with blood-glucose monitoring. [CORRECTED: the source says “Do not give” here, but its own treatment section says “Administer 10% glucose at a dose of 2 ml/kg (200 mg/kg)” and its neonatal-hypoglycaemia list repeats “Glucose (10%): 2 ml/kg”. The negation is a translation artefact.] SOURCE-DERIVED — verify before clinical use.","status": "source-derived","category": "traps","sourceAtomId": "LEK-01538"},
  ...
  {"id": 540,"front": "LEK source drill — What number, timing, or threshold is listed under Cardiology & rheumatology?","back": "GIVE 10% calcium gluconate 1 mL/kg IV, infused SLOWLY over ~10 minutes with continuous cardiac-rhythm monitoring — it is the SPEED that causes arrhythmia, not the dose. [CORRECTED: the card previously read “Avoid 1 ml/kg over 10 minutes”, which reverses the instruction. The source’s own treatment section says “Administer 10% calcium gluconate solution at a dose of 1 mL/kg” and “Monitor cardiac rhythm”.] Legacy source number — verify against current local/national guidance before clinical use.","status": "source-derived","category": "numbers","sourceAtomId": "LEK-01546"},
