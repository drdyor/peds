...
export const sheets: Sheet[] = [
  ...
  { file: "sheets/sheet-24-pediatric-dermatology-c.webp", number: "24", title: "Pediatric dermatology", variant: "c" },
  ...
  { file: "sheets/sheet-27-monogenic-diabetes-metabolic-pearls.webp", number: "27", title: "Monogenic diabetes & metabolic pearls" },
  { file: "sheets/sheet-28-metabolic-disorders-description-to-diagnosis.webp", number: "28", title: "Metabolic disorders — description to diagnosis" },
  { file: "sheets/sheet-29-rickets-master.webp", number: "29", title: "Rickets master" },
  { file: "sheets/sheet-30-viral-exanthems-skin-presentations.webp", number: "30", title: "Viral exanthems & skin presentations" },
  { file: "sheets/sheet-31-vitamin-deficiencies-master.webp", number: "31", title: "Vitamin deficiencies master" },
  { file: "sheets/sheet-32-childhood-cancers-master.webp", number: "32", title: "Childhood cancers master" },
  { file: "sheets/sheet-33-anaemias-master.webp", number: "33", title: "Anaemias master" },
  { file: "sheets/sheet-34-karyotypes-syndromes-weird-chromosomes.webp", number: "34", title: "Karyotypes, syndromes & weird chromosomes" },
  { file: "sheets/sheet-35-drugs-contraindicated-or-cautioned-in-children.webp", number: "35", title: "Drugs contraindicated or cautioned in children" },
];
